...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    super.initState();
    final profile = LocalStore.userProfile;
    _nameController = TextEditingController(text: profile.name);
    _fatherController = TextEditingController(text: profile.father);
    _familyController = TextEditingController(text: profile.family);
  ...
  Future<void> _save() async {
    ...
    await LocalStore.putUserProfile(profile);
    if (!mounted) return;
